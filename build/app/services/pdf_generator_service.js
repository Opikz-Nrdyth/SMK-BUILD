...
export class PdfGeneratorService {
    ...
    createDocument(paperSize = 'A4', customWidth, customHeight) {
    ...
    getPaperSize(paperSize, customWidth, customHeight) {
        const sizes = {
    ...
    addPaymentDetails(invoiceData) {
        ...
        currentY += 12;
        invoiceData.riwayatPembayaran.forEach((item, index) => {
...
//# sourceMappingURL=pdf_generator_service.js.map