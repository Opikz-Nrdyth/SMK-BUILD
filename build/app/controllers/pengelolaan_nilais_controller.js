...
export default class PengelolaanNilaiController {
    ...
    async getUjian({ response, params }) {
    ...
    async getNilai({ response, params }) {
        ...
        const daftarNisn = typeof dataKelas?.siswa == 'string' ? JSON.parse(dataKelas?.siswa) : dataKelas?.siswa;
...
//# sourceMappingURL=pengelolaan_nilais_controller.js.map