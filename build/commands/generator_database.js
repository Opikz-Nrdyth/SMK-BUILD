...
export default class GeneratorDatabase extends BaseCommand {
    ...
    static description = 'Generate Lucid model and Vine validator from MySQL table';
    async run() {
        ...
        const columns = await db.from(tableName).columns;
...
//# sourceMappingURL=generator_database.js.map