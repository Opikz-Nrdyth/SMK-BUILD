class OfflineStorageService {
  ...
  async saveAbsensi(absensi: any[]): Promise<void> {
    ...
    try {
      ...
      return new Promise((resolve, reject) => {
        const transaction = db.transaction(['absensi'], 'readwrite')
  ...
  async getPendingAbsensi(): Promise<any[]> {
    ...
    try {
      ...
      return new Promise((resolve, reject) => {
        const transaction = db.transaction(['absensi'], 'readonly')
        const store = transaction.objectStore('absensi')
