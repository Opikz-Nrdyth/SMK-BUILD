...
export default function FormEdit({
  ...
  const { data, setData, processing, errors } = useForm<AbsensiItem>(
    initialValues || {
      userId: '',
      mapelId: '',
      kelasId: '',
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6">
      ...
      {initialValues?.userName && (
        <div className="bg-purple-50 dark:bg-gray-700 p-4 rounded-lg border border-purple-200">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm dark:text-white">
            ...
            <div>
              <span className="font-medium">Mata Pelajaran:</span> {initialValues.mapelName}
            </div>
            <div>
      ...
      <div className="flex justify-end space-x-3 pt-6 border-t border-gray-200">
        <a
          href="/SuperAdmin/laporan-absensi"
